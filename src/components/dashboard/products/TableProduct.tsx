...
export const TableProduct = () => {
	...
	return (
		<div className='flex flex-col h-full min-h-[500px] border border-gray-200 dark:border-gray-600 rounded-lg p-3 bg-white gap-3 dark:bg-gray-900 dark:text-gray-100'>
			<div className='flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3'>
				<div className='flex flex-col'>
					<h1 className='text-xl font-bold text-gray-800 dark:text-gray-100 drop-shadow-[0_2px_2px_rgba(0,0,0,0.4)]'>Productos</h1>
					<p className='text-xs mb-1 font-regular text-gray-500 dark:text-gray-300'>Gestiona tus productos y mira las estadísticas de tus ventas</p>
				</div>
									...
									<tr key={index}>
										...
										<td className='relative'>
											<button
												...
												onBlur={() => setTimeout(() => setOpenMenuIndex(null), 150)}
											>
												<FaEllipsis />
											</button>
											{openMenuIndex === index && (
