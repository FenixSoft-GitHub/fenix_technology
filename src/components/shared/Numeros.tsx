...
const Numeros = () => {
  ...
  return (
    <section
      ref={ref}
      className="w-full max-w-[1300px] mx-auto p-6 md:p-8 lg:p-10 bg-gray-200/50 rounded-lg mt-4 shadow-md"
    >
      <h2 className="text-3xl lg:text-5xl text-center text-balance mb-10 lg:mb-20 font-semibold font-lexend text-gray-900 drop-shadow-[0_3px_3px_rgba(0,0,0,0.5)]">
